...
function loadFeedback() {
    ...
    */
    ...
    document.querySelector("#content").insertBefore(newDiv, document.querySelector("#byui-copyright"));
...
function createSurvey(location, data) {
    ...
    if (uniqueFormats.length > 0) {
        ...
        surveyFrame.position = "absolute";
        surveyFrame.top = "100px";
        surveyFrame.left = "100px";
        surveyFrame.width = "80%";
        surveyFrame.height = "80%";
        surveyFrame.backgroundColor = defaultBackgroundColor;
        surveyFrame.zIndex = 1000;
        document.querySelector("#wrapper").appendChild(surveyFrame);
